...
\frametitle{Business Practices of Small Firms}
	...
	\begin{itemize_2pt}
		...
		\begin{itemize_2pt}
			...
			\item 
		\end{itemize_2pt}
	\item Does adoption of "best practices" \emph{cause} increase in performance?
	\item How can practice adoption best be facilitated?
	\end{itemize_2pt}
\end{frame}
...
\frametitle{Training Specific Domains}
	...
	\begin{enumerate_2pt}
		\item Finance/accounting skills
		\begin{itemize_2pt}
			\item Increased profits
			\item "Efficiency focus" on lower costs
			\item[] $\rightarrow$ Benefits established businesses (less market exposure)
		\end{itemize_2pt}
		\item Marketing/sales skills
		\begin{itemize_2pt}
			\item Increased profits
...
\begin{frame}
\frametitle{Training Specific Domain}
	\begin{itemize_2pt}
...
We directly measure business aspirations .. 
\begin{itemize_2pt}
