...
Standard Production Decision
	\begin{itemize_2pt}
		\item Owner maximizes output $Y = f(A, L, M, K)$ at given wealth $W$:	
		
		\item[] $\boxed{\begin{aligned} \max _{K, M, L} &\{\textcolor{red}{p} &\ f(\textcolor{red}{A}, \textcolor{bdf}{L, M, K})-\textcolor{red}{w} \textcolor{bdf}{L}-\textcolor{red}{s} \textcolor{bdf}{M}-\textcolor{red}{r} \textcolor{bdf}{K}\} \end{aligned}}$
		\item[] $\begin{aligned} \text{s.t.} &\ \textcolor{red}{w} \textcolor{bdf}{L}+\textcolor{red}{s} \textcolor{bdf}{M}+\textcolor{red}{r} \textcolor{bdf}{K} \leq \lambda W \end{aligned}$
		
		\begin{itemize_2pt}
			\item[] .. where $\textcolor{bdf}{L}$ is labor, $\textcolor{bdf}{M}$ is materials, and $\textcolor{bdf}{K}$ is capital.
			\item[] .. where $\textcolor{red}{p}$ is the output price, $\textcolor{red}{w}$ the cost of labor, $\textcolor{red}{s}$ the cost of raw materials, $\textcolor{red}{r}$ cost of capital, and $\textcolor{red}{A}$ 							represents a productivity factor.
		\end{itemize_2pt}
