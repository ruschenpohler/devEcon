...
\begin{itemize_2pt}
	...
	\begin{itemize_2pt}
		\item Evidence for trait-like persistence of preference (see, e.g.,\textcolor{camel}{Waldner et al., 1998, Engler et al., 2010})%[citation]
...
\begin{itemize_2pt}
	...
	\begin{itemize_2pt}
		...
		\item[] \quad \citet[See also,][]{Galiani2018}
	\end{itemize_2pt}
