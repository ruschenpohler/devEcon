...
\frametitle{Business Practices of Small Firms}
	...
	\begin{itemize_2pt}
		\item 5 major domains of business practices
		\begin{enumerate_2pt}
...
\frametitle{Targeted Training}
	...
	\begin{itemize_2pt}
		...
		\begin{itemize_2pt}
			\item Treating individuals with particular promise (e.g., high-growth firms)
			\item[] $\rightarrow$ \textcolor{bdf}{Maximizing impact} (or cost-effectiveness)
			\item Serving marginalized or disadvantaged groups
			\item[] $\rightarrow$ Alleviating \textcolor{bdf}{particularly severe constraints}
			\item[] $\rightarrow$ 
			\item \textcolor{bdf}{Maximizing statistical power} through homogeneity
		\end{itemize_2pt}
